                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.recent_actors,
                          size: 70.0, color: Color((0xFF21BFBD))),
                      Text("Requests", style: new TextStyle(fontSize: 17.0))
                    ],
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.person_add,
                          size: 70.0, color: Color((0xFF21BFBD))),
                      Text("Create Group", style: new TextStyle(fontSize: 17.0))
                    ],
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.group_add,
                          size: 70.0, color: Color((0xFF21BFBD))),
                      Text("Join Group", style: new TextStyle(fontSize: 17.0))
                    ],
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.exit_to_app,
                          size: 70.0, color: Color((0xFF21BFBD))),
                      Text("Leave Group", style: new TextStyle(fontSize: 17.0))
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.subject,
                          size: 70.0, color: Color((0xFF21BFBD))),
                      Text("Submition", style: new TextStyle(fontSize: 17.0))
                    ],
                  ),
                ),
              ),
